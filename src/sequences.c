...
//            roll, pitch, yaw, delta_x, delta_y);
    ...
    if ((original_point = gsl_matrix_alloc(4, 1)) == NULL) {
        log_warn("Failed to allocate matrix for stretching");
        goto FAIL;
    }
    ...
    gsl_blas_dgemm(CblasNoTrans, CblasNoTrans, 1.0,
                    trans, original_point, 0.0, tmp);

    gsl_blas_dgemm(CblasNoTrans, CblasNoTrans, 1.0,
                    yaw_rotation, tmp, 0.0, tmp2);

    gsl_blas_dgemm(CblasNoTrans, CblasNoTrans, 1.0,
                    pitch_rotation, tmp2, 0.0, tmp);

    gsl_blas_dgemm(CblasNoTrans, CblasNoTrans, 1.0,
                    roll_rotation, tmp, 0.0, tmp2);
...
point_t seq_stand_to_turn_left_creep(int leg_num, Leg *leg) {
    ...
    static point_t seq[] = {
        ...
        {-87, 132, DOWN},  {152, 107, DOWN}, {-112, -107, DOWN}, {171, -77, 50},
        {-84, 154, DOWN},  {154, 124, DOWN}, {-114, -84, DOWN},  {176, -46, DOWN},
        /* Step front right */
        ...
        {-90, 144, DOWN},  {97, 140, 50},    {-144, -90, DOWN},  {148, -82, DOWN},
        {-105, 127, DOWN}, {65, 127, DOWN},  {-167, -105, DOWN}, {127, -105, DOWN},
        /* Step back left */
        ...
        {-89, 155, DOWN},  {80, 137, DOWN},  {-134, -126, 50},   {117, -100, DOWN},
        {-86, 176, DOWN},  {84, 154, DOWN},  {-124, -114, DOWN}, {114, -84, DOWN},
        /* Step front left */
        ...
        {-131, 158, 50},   {98, 142, DOWN},  {-138, -102, DOWN}, {102, -98, DOWN},
        {-120, 120, DOWN}, {120, 120, DOWN}, {-120, -120, DOWN}, {120, -120, DOWN},
    };
    if (frame > last_frame) {
        frame = 0;
...
point_t seq_stand_to_turn_right_creep(int leg_num, Leg *leg) {
    ...
    static point_t seq[] = {
        ...
        {-112, 107, DOWN}, {127, 132, DOWN}, {-87, -132, DOWN},  {97, -151, 50},
        {-115, 123, DOWN}, {123, 155, DOWN}, {-83, -115, DOWN},  {85, -137, DOWN},
        /* Step front right */
        ...
        {-145, 89, DOWN},  {140, 96, 50},    {-89, -145, DOWN},  {81, -149, DOWN},
        {-167, 65, DOWN},  {127, 65, DOWN},  {-105, -167, DOWN}, {105, -167, DOWN},
        /* step back left */
        ...
        {-175, 69, DOWN},  {117, 100, DOWN}, {-146, -114, 50},   {120, -137, DOWN},
        {-177, 85, DOWN},  {115, 123, DOWN}, {-155, -83, DOWN},  {123, -115, DOWN},
        /* step front left */
...
point_t seq_stand_to_walk_creep(int leg_num, Leg *leg) {
    ...
    static point_t seq[] = {
        ...
        {-115, 198, UP},   {125, 134, DOWN}, {-115, -134, DOWN}, {125, -198, DOWN},
        {-110, 214, 65},   {130, 129, DOWN}, {-110, -129, DOWN}, {120, -214, DOWN},
        {-105, 230, DOWN}, {135, 123, DOWN}, {-105, -123, DOWN}, {115, -230, DOWN},
        /*------------------- BACK RIGHT STEP ------------------------------*/
        {-100, 224, DOWN}, {140, 118, DOWN}, {-100, -128, DOWN}, {140, -214, 50},
        ...
        {-100, 182, DOWN}, {140, 75, DOWN},  {-100, -172, DOWN}, {140, -86, 50},
        {-100, 176, DOWN}, {140, 70, DOWN},  {-100, -176, DOWN}, {140, -70, DOWN},
        /*------------------- FRONT RIGHT STEP -----------------------------*/
        {-100, 171, DOWN}, {140, 86, 50},    {-100, -182, DOWN}, {140, -75, DOWN},
        ...
        {-140, 75, DOWN},  {100, 182, DOWN}, {-140, -86, 50},    {100, -171, DOWN},
        {-140, 70, DOWN},  {100, 176, DOWN}, {-140, -70, DOWN},  {100, -176, DOWN},
        /*------------------- FRONT LEFT STEP ------------------------------*/
        {-140, 86, 50},    {100, 171, DOWN}, {-140, -75, DOWN},  {100, -182, DOWN},
        ...
        {-134, 166, UP},   {110, 144, DOWN}, {-134, -102, DOWN}, {110, -208, DOWN},
        {-128, 182, UP},   {116, 139, DOWN}, {-128, -107, DOWN}, {116, -214, DOWN},
        {-122, 198, UP},   {122, 134, DOWN}, {-122, -112, DOWN}, {122, -219, DOWN},
        {-116, 214, 50},   {128, 128, DOWN}, {-116, -118, DOWN}, {128, -224, DOWN},
